...
/*
https://www.cnblogs.com/zjwstu/articles/17225301.html
https://developer.aliyun.com/article/654267

*/

/*!!!
反反复复看了很多博客ping实现 终于能看明白个大概了
比如校验和 这个东西需要先接受他的算法方式 具体怎么用 再说
但是 在第一次阅读的时候不知道他干什么用的 会天然排斥 于是看不下去
*/
//定义ICMP结构体
type ICMP struct {
	Type        uint8
...
func main() {
	...
	desIP := args[len(args)-1] //于此 最后一个参数必须是主机地址 不然肯定解析不到
